...
1.  Presentación del equipo de talleristas

2.  Introducción a la biología del virus del Ébola
...
![doi: 10.1038/s41572-020-0147-3.](TallerEbola-ppt_files/img/ebola_outbreaks.jpg)
...
::: columns
::: {.column width="70%"}
![https://www.reconlearn.org/post/outbreakstatsprimer.html](TallerEbola-ppt_files/img/inicio_del_brote.png)
:::
...
## Datos mínimos necesarios usuales en epidemias nuevas
...
-   Datos generales de individuo: edad, género, ocupación, etc
...
-   Tómese su tiempo para mirar los datos y la estructura
...
![https://www.reconlearn.org/post/outbreakstatsprimer.html](TallerEbola-ppt_files/img/CFR_pie.png)
...
![https://www.reconlearn.org/post/outbreakstatsprimer.html](TallerEbola-ppt_files/img/curv_epi_loglineal.png)
...
\left.
\begin{matrix}
y:\text{número de casos incidentes} \\
...
![](TallerEbola-ppt_files/img/curv_epi_exp.png)
:::
...
<center>Mirando la gráfica y el ajuste, **¿cree que este es un ajuste más razonable comparado con el anterior?**</center>
:::
:::
...
<center>**¿El modelo se ajusta bien a los datos?**</center>
...
::: columns
::: {.column width="60%"}
<font size="5"> [![https://www.reconlearn.org/post/outbreakstatsprimer.html](TallerEbola-ppt_files/img/doubling_time_scheme.png)](https://www.reconlearn.org/post/outbreakstatsprimer.html)
...
![https://www.reconlearn.org/slides/outbreak-statistics/outbreak-statistics#19](TallerEbola-ppt_files/img/likelihood_reminder.png)

## Estimación del intervalo serial

![https://www.reconlearn.org/slides/outbreak-statistics/outbreak-statistics#16](TallerEbola-ppt_files/img/serial_interval_toon.png)
