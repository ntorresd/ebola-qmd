...
razon_letalidad <- numero_muertes / numero_con_resultado_conocido
razon_letalidad
```
:::
...
razon_letalidad_con_CI <- binom.confint(numero_muertes, numero_con_resultado_conocido, method = "exact") %>%   
  kable(caption = "**razon de letalidad con intervalos de confianza**") 
razon_letalidad_con_CI
```
:::
